...
class InputSurface {
    ...
    /**
     * Discard all resources held by this class, notably the EGL context. Also releases the Surface that was passed to the constructor.
     */
    public void release() {
    ...
    /**
     * Makes EGL context and surface current.
     */
