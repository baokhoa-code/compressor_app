...
public class VideoFilesActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void showNormalVideo() {
        normalVideos = fetchNormalVideo(folder_name);
        videoFilesAdapter = new VideoFilesAdapter(normalVideos, this, 0);
    ...
    @SuppressLint("Range")
    private ArrayList<NormalVideo> fetchNormalVideo(String folderName) {
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        ArrayList<NormalVideo> mediaFiles = new ArrayList<>();
        for (NormalVideo media : normalVideos) {
