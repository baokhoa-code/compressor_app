...
public class VideoPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ArrayList<NormalVideo> mVideoFiles = new ArrayList<>();
    ...
    private ImageView videoBack, lock, unlock, scaling, videoList, videoMore;
    ...
    private TextView vol_text, brt_text, total_duration;
    ...
    private TextView zoom_perc;
    private ScaleGestureDetector scaleGestureDetector;
    private RelativeLayout double_tap_playpause;
...
//                    }
                ...
                if (position == 8) {
                    //speed
                    MaterialAlertDialogBuilder alertDialog =  new MaterialAlertDialogBuilder(VideoPlayerActivity.this);
                    ...
                    filePickerDialog.setDialogSelectionListener(new DialogSelectionListener() {
                        ...
                        public void onSelectedFilePaths(String[] files) {
                            for (String path : files) {
                                ...
                                uriSubtitle = Uri.parse(file.getAbsolutePath());
                            }
...
//        nightMode = findViewById(R.id.night_mode);
    ...
    public void onClick(View v) {
        ...
        if (vId == R.id.video_back) {
            if (player != null) {
                player.release();
            }
            finish();
        } else if (vId == R.id.video_list) {
        ...
        } else if (vId == R.id.lock) {
            controlsMode = ControlsMode.FULLSCREEN;
            root.setVisibility(View.VISIBLE);
            lock.setVisibility(View.INVISIBLE);
            Toast.makeText(this, "unLocked", Toast.LENGTH_SHORT).show();
        } else if (vId == R.id.unlock) {
            controlsMode = ControlsMode.LOCK;
            root.setVisibility(View.INVISIBLE);
            lock.setVisibility(View.VISIBLE);
            Toast.makeText(this, "Locked", Toast.LENGTH_SHORT).show();
        } else if (vId == R.id.exo_next) {
            try {
                player.stop();
                position++;
                playVideo();
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (id == R.id.next) {
                        ...
                        Log.e("TestMetMoi", mVideoFiles.get(position).getPath());
                        ...
                        MaterialAlertDialogBuilder alertDialogDelete =  new MaterialAlertDialogBuilder(VideoPlayerActivity.this);
